...
env = environ.Env(
    ...
    DATABASE_NAME=(str, "dvlyadmin_mini"),

    REDIS_PASSWORD=(str, ""),
    REDIS_HOST=(str, '127.0.0.1'),
    REDIS_PORT=(str, "6379"),

    DOMAIN_HOST=(str, "http://127.0.0.1:8000"),

    API_LOG_ENABLE=(bool, True),
...
REDIS_URL = f'redis://:{env("REDIS_PASSWORD") or ""}@{env("REDIS_HOST")}:{env("REDIS_PORT")}'
...
DOMAIN_HOST = env("DOMAIN_HOST")  # 控制图片上传后保存所使用到的url前缀
